                            ...
                            <el-table :data="log_v.attributes" stripe :show-header="false" style="width: 100%" v-if="scope.row.bar.log[log_i].show">
                                ...
                                <el-table-column>
                                    <template slot-scope="scope">
                                        ...
                                        <!-- 异常文本 换行格式化 -->
                                        <pre v-else-if="scope.row.key=='error.panic' || scope.row.key=='sql' || scope.row.key=='statement'" style="max-height: 350px;overflow: auto;line-height: 120%;">{{scope.row.value.value}}</pre>
                                        <!-- 默认展示 -->

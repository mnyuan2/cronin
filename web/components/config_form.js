        ...
        <el-form :model="gitSet.event" label-width="90px" size="small">
            ...
            <div v-if="gitSet.data.id==8"> 
                ...
                <el-form-item label="目标状态*">
                    <el-select v-model="gitSet.data.pr_is_merge.state">
                        <el-option label="可合并" value="open">
                            <span style="float: left">可合并</span>
                            <span style="float: right; color: #8492a6; font-size: 13px; padding-left: 26px;">PR 状态为开启并且无冲突</span>
                        </el-option>
                        <el-option label="已合并" value="merge">
                            <span style="float: left">已合并</span>
                            <span style="float: right; color: #8492a6; font-size: 13px; padding-left: 26px;">PR 状态为已合并</span>
                        </el-option>
                    </el-select>
                </el-form-item>
    ...
    methods:{
        ...
        gitSetConfirm(){
            ...
            if (this.gitSet.data.id == 2){
                ...
                if (!this.gitSet.data.pr_is_merge.state){
        ...
        gitBuildDesc(data){
            switch (data.id){
                ...
                case 3:
                    ...
                    break
                case 8:
                    data.desc = `<b>pr合并校验</b> <a href="https://gitee.com/${data.pr_is_merge.owner}/${data.pr_is_merge.repo}/pulls/${data.pr_is_merge.number}" target="_blank" title="点击 查看pr详情"><i class="el-icon-connection"></i></a> <b class="b">${data.pr_is_merge.owner}/${data.pr_is_merge.repo}</b>/pulls/<b class="b">${data.pr_is_merge.number}</b>`
                    break
                case 9:

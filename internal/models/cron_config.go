...
type CronConfig struct {
	...
	Command      []byte `json:"command" gorm:"column:command;type:text;default:null;comment:命令内容;"`
	...
	MsgSet       []byte `json:"msg_set" gorm:"column:msg_set;type:text;default:null;comment:消息配置详情;"`
}

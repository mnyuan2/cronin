...
type CronSetting struct {
	Id       int    `json:"id" gorm:"primary_key;column:id;type:INTEGER;comment:主键;"`
	Scene    string `json:"scene" gorm:"column:scene;type:varchar(255);index:setting_env,priority:12;comment:使用场景;"`
	...
	Env      string `json:"env" gorm:"column:env;type:varchar(256);index:setting_env,priority:11;comment:环境:system.系统信息、其它.业务环境信息;"`
...
func (m *CronSetting) TableName() string {
	return "cron_setting"
}

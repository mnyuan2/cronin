		...
		db.CreateInBatches([]*CronAuthRole{
			{
				...
				Name:    "管理员",
				Remark:  "所有权限",
				AuthIds: "20,21,22,23,24,25,30,31,32,33,34,60,61,62,63,70,71,72,74,75,80,81,82,83,90,91,92,95,100,101,102,104,105",
				Status:  enum.StatusActive,
			},
			{
				Id:      2,
				Name:    "负责人",
				Remark:  "负责任务的创建与审核",
				AuthIds: "20,21,22,23,24,25,30,31,32,33,34,61,71,80,81,82,83,91",
				Status:  enum.StatusActive,
			},
			{
				Id:      3,
				Name:    "标准",
				Remark:  "负责任务的创建并提交审核",
				AuthIds: "21,22,23,25,31,32,33,71,81",
				Status:  enum.StatusActive,
			},
		}, 10)
	}

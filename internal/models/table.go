		...
		Db.CreateInBatches([]*CronAuthRole{
			{
				...
				Name:    "管理员",
				Remark:  "所有权限",
				AuthIds: "20,21,22,23,24,25,30,31,32,33,34,35,60,61,62,63,70,71,72,74,75,80,81,82,83,90,91,92,95,100,101,102,104,105,120,121,124,125,150,151,152,153,154,155,160,161,162,163",
				Status:  enum.StatusActive,
			},
			{
				Id:      2,

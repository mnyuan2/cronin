...
var authList = []*Permission{
	...
	{Id: 62, Path: "/setting/source_set", Title: "新增/编辑", Group: "链接资源", Type: AuthTypeGrant},
	...
	{Id: 72, Path: "/setting/env_set", Title: "新增/编辑", Group: "环境", Type: AuthTypeGrant},
	...
	{Id: 92, Path: "/user/set?auth_type=add", Title: "新增", Group: "用户", Type: AuthTypeGrant},
	{Id: 92, Path: "/user/set?auth_type=edit", Title: "编辑", Group: "用户", Type: AuthTypeGrant},
	{Id: 92, Path: "/user/set", Title: "编辑登录", Group: "用户", Type: AuthTypeLogin},
	...
	{Id: 102, Path: "/role/set", Title: "新增/编辑", Group: "角色", Type: AuthTypeGrant},
